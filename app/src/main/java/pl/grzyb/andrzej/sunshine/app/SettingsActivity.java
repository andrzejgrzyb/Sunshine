...
public class SettingsActivity extends PreferenceActivity
    ...
    // When going up from the setting to the main activity.
    // The app should look for previous running MainActivity instead of creating a new one.
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_location_key))) {
            ...
            // fisrt clear locationStatus
            Utility.resetLocationStatus(this);
            SunshineSyncAdapter.syncImmediately(this);
        } else if (key.equals(getString(R.string.pref_units_key))) {
            // units have changed. update lits of weather entries accordingly
